            ...
            >
              ...
              <MOTION.div variants={fadeInUp} className="space-y-4">
                <p className="text-sm sm:text-base md:text-lg leading-relaxed text-[#6B4E39]">
                  SVM Timber is a family legacy passed down for generations.
                ...
                <p className="text-sm sm:text-base md:text-lg leading-relaxed text-[#6B4E39]">
                  ...
                  honour the timeless beauty, strength, and character of
                  wood—crafted with care to last for decades.
                </p>
              </MOTION.div>
