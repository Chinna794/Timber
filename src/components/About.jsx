...
// // // // // //   return (
// // // // // //     <section className="bg-[#F5EBDF] text-[#4A3124]">
      
// // // // // //       {/* Our Story & Heritage */}
// // // // // //       <div className="py-12 sm:py-16 md:py-20">
// // // // // //         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
// // // // // //           <h2 className="text-2xl sm:text-3xl md:text-4xl text-center font-playfair font-bold mb-10">
// // // // // //             Our Story &amp; Heritage
// // // // // //           </h2>

// // // // // //           <div className="grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.2fr)] items-center">
// // // // // //             {/* Left image */}
// // // // // //             <div className="rounded-2xl overflow-hidden shadow-xl bg-[#D8C6A6]">
// // // // // //               <img
// // // // // //                 src="/img/about/craftsman.jpg"  // TODO: craftsman / workshop photo
...
// // // // // //               <h3 className="text-xl sm:text-2xl md:text-3xl font-playfair font-semibold">
// // // // // //                 A Legacy Carved in Wood, Since 1985
// // // // // //               </h3>

// // // // // //               <p className="text-sm sm:text-base leading-relaxed text-[#6B4E39]">
...
// // // // // //                 <button className="px-6 py-3 rounded-full bg-[#8B5E34] text-white text-sm sm:text-base font-medium shadow-md hover:bg-[#774b26] transition-colors">
// // // // // //                   Explore Our Products
// // // // // //                 </button>
// // // // // //                 <button className="px-6 py-3 rounded-full border border-[#8B5E34] text-[#4A3124] bg-[#F5EBDF] text-sm sm:text-base font-medium hover:bg-[#E9DDCB] transition-colors">
// // // // // //                   Our Wood Story
// // // // // //                 </button>
// // // // // //               </div>
// // // // // //             </div>
...
// // // // // //       <div className="bg-[#F0E2CF] py-12 sm:py-16">
// // // // // //         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
// // // // // //           <h2 className="text-2xl sm:text-3xl md:text-4xl text-center font-playfair font-bold mb-10">
// // // // // //             The Importance of Quality Wood
// // // // // //           </h2>
...
// // // // // //               <div className="w-12 h-12 mx-auto rounded-full bg-[#D8E4C4] flex items-center justify-center text-xl">
// // // // // //                 <span>🌲</span>
// // // // // //               </div>
// // // // // //               <h3 className="text-sm sm:text-base md:text-lg font-semibold">
// // // // // //                 Sustainably Sourced
// // // // // //               </h3>
// // // // // //               <p className="text-xs sm:text-sm text-[#6B4E39] leading-relaxed">
...
// // // // // //             {/* Card 2 */}
// // // // // //             <div className="space-y-3">
// // // // // //               <div className="w-12 h-12 mx-auto rounded-full bg-[#E2D8B8] flex items-center justify-center text-xl">
// // // // // //                 <span>🛡️</span>
// // // // // //               </div>
// // // // // //               <h3 className="text-sm sm:text-base md:text-lg font-semibold">
...
// // // // // //             {/* Card 3 */}
// // // // // //             <div className="space-y-3">
// // // // // //               <div className="w-12 h-12 mx-auto rounded-full bg-[#E5D5C8] flex items-center justify-center text-xl">
// // // // // //                 <span>💚</span>
// // // // // //               </div>
// // // // // //               <h3 className="text-sm sm:text-base md:text-lg font-semibold">
// // // // // //                 A Living Material
...
// // // // // //               <div
// // // // // //                 key={card.title}
// // // // // //                 className="bg-[#F7EFE4] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-shadow"
// // // // // //               >
// // // // // //                 <div className="h-40 sm:h-44 lg:h-48 overflow-hidden">
// // // // // //                   <img
// // // // // //                     src={card.img}        // TODO: replace with your images
// // // // // //                     alt={card.title}
// // // // // //                     className="w-full h-full object-cover"
// // // // // //                   />
// // // // // //                 </div>
// // // // // //                 <div className="px-4 py-4 text-center">
// // // // // //                   <p className="text-xs sm:text-sm md:text-base font-medium font-playfair">
// // // // // //                     {card.title}
// // // // // //                   </p>
// // // // // //                 </div>
// // // // // //               </div>
...
// // // //             <div className="space-y-4">
// // // //               <h3 className="text-xl sm:text-2xl md:text-3xl font-playfair font-semibold">
// // // //                 A Legacy Carved in Wood, Since 1982
// // // //               </h3>
...
// // //     // Scroll to timber section on home page
// // //     const timberSection = document.getElementById('timber');
// // //     if (timberSection) {
// // //       timberSection.scrollIntoView({ behavior: 'smooth' });
// // //     }
// // //   };
...
// // //                   className="px-6 py-3 rounded-full bg-[#8B5E34] text-white text-sm sm:text-base font-medium shadow-md hover:bg-[#774b26] transition-colors"
// // //                 >
// // //                   Explore Our Products
// // //                 </button>
// // //                 <button 
// // //                   onClick={handleWoodStory}
// // //                   className="px-6 py-3 rounded-full border border-[#8B5E34] text-[#4A3124] bg-[#F5EBDF] text-sm sm:text-base font-medium hover:bg-[#E9DDCB] transition-colors"
// // //                 >
// // //                   Our Story
// // //                 </button>
// // //               </div>
...
// //   const handleExploreProducts = () => {
// //     // Navigate to timber products page
// //     navigate('/timber');
// //   };
...
//   return (
//     <section className="bg-gradient-to-b from-[#FAF3E0] via-[#F5EBDF] to-[#F0E2CF] text-[#4A3124]">
//       {/* Our Story & Heritage */}
...
//       {/* The Importance of Quality Wood */}
//       <div className="bg-gradient-to-b from-[#F0E2CF] to-[#E5D5C8] py-16 sm:py-20">
//         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
//           <MOTION.div
//             initial="hidden"
//             whileInView="visible"
...
//               className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#E5D5C8]"
//             >
//               <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-[#D8E4C4] to-[#C2D6A4] flex items-center justify-center text-3xl shadow-md mb-4">
//                 <span>🌲</span>
//               </div>
//               <h3 className="text-base sm:text-lg md:text-xl font-bold mb-3 text-[#4A3124] font-playfair">
//                 Sustainably Sourced
//               </h3>
...
//               className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#E5D5C8]"
//             >
//               <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-[#E2D8B8] to-[#D4C49A] flex items-center justify-center text-3xl shadow-md mb-4">
//                 <span>🛡️</span>
//               </div>
//               <h3 className="text-base sm:text-lg md:text-xl font-bold mb-3 text-[#4A3124] font-playfair">
//                 Durability &amp; Longevity
...
//               className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#E5D5C8]"
//             >
//               <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-[#E5D5C8] to-[#D9C5B5] flex items-center justify-center text-3xl shadow-md mb-4">
//                 <span>💚</span>
//               </div>
//               <h3 className="text-base sm:text-lg md:text-xl font-bold mb-3 text-[#4A3124] font-playfair">
//                 A Living Material
...
//       {/* Our Craftsmanship */}
//       <div className="bg-gradient-to-b from-[#E5D5C8] to-[#F5EBDF] py-16 sm:py-20 md:py-24">
//         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
//           <MOTION.div
//             initial="hidden"
//             whileInView="visible"
