      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="mb-6 md:mb-0 md:w-1/3">
            <h2 className="text-xl font-bold">SVM Timbers</h2>
            <p className="mt-2 text-gray-300">Premium timber suppliers committed to quality, sustainability, and craftsmanship.</p>
          </div>
          ...
          <div className="mb-6 md:mb-0 md:w-1/4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#timber" className="text-gray-400 hover:text-white transition-colors duration-200">Timber</a></li>
          ...
          <div className="md:w-1/4">
            ...
            <address className="not-italic text-gray-300">
              <p>123 Timber Lane</p>
              <p>Forest City, FC 12345</p>
              <p className="mt-2">
                <a href="mailto:info@svmtimbers.com" className="text-gray-400 hover:text-white transition-colors duration-200">
                  info@svmtimbers.com
                </a>
              </p>
              <p>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-gray-400 text-sm">
            © {currentYear} SVM Timbers. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
